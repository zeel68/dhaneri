...
import { Heart, Share2, Star, Truck, Shield, RotateCcw, Minus, Plus, ShoppingCart, Eye, ChevronLeft, ChevronRight, Package, Award, Clock, Users, MessageCircle, ChevronDown, Info, X, MapPin, Phone, Mail, Copy, Check, ArrowRight, Crown, Gift, TrendingUp, Verified, CreditCard, ShieldCheck } from 'lucide-react';
                        ...
                        <div className="bg-amber-50 rounded-xl p-4 border border-amber-200">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className="text-slate-600">({product.ratings.count} reviews)</span>
                                </div>
                                {product.ratings.count > 0 && (
                                    <div className="text-green-700 font-semibold text-sm">
                                        {Math.round((product.ratings.average / 5) * 100)}% recommended
                                    </div>
                                )}
                            </div>
                        </div>
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    {product.variants.map((variant) => (
                                        <button
                                            ...
                                            className={`p-3 rounded-xl border-2 transition-all duration-300 ${selectedVariant?._id === variant._id
                                ...
                                <div className="grid grid-cols-5 gap-2 mb-3">
                                    {selectedVariant.sizes.map((sizeOption) => (
                                        <button
                                            ...
                                            className={`py-2 px-2 border-2 rounded-lg font-semibold transition-all duration-300 text-center ${selectedSize?._id === sizeOption._id
